...
class FiltrosController extends Controller {
    ...
    /**
     * @Route("/filtragem/{inicio}/{fim}")
     */
    public function filtragemAction(Request $request, $inicio, $fim) {


        $from = new \DateTime($inicio);
        $to = new \DateTime($fim);
        ...
        $queryBuilderAcao
                ...
                ->andWhere($queryBuilderAcao->expr()->between('a.dtacao', ':date_from', ':date_to'))
                ->setParameters(array(
                    'date_from' => $from,
                    'date_to' => $to,
                ))
        ...
        $resultadoAcao = $queryBuilderAcao->getQuery()->getArrayResult();
          $this->logControle->log("filtragem : " . print_r($resultadoAcao, true));
        $dadosAcao = array();
